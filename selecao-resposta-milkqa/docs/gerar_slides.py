...
slide_conteudo(
    ...
    [
        ...
        "3. Cross-Encoder — self-attention conjunta sobre o par pergunta+candidata, congelado",
...
# ---------------------------------------------------------------------
# 10. Demonstracao ao vivo (transicao para o notebook)
# ---------------------------------------------------------------------
slide_conteudo(
    "Demonstração ao Vivo",
    [
        "Uma pergunta real do conjunto de teste (nunca vista em treino) ranqueada por 3 métodos, ao vivo, sem retreinar nada:",
        ("1. TF-IDF — léxico puro", 1),
        ("2. Cosseno sobre BERTimbau congelado — neural, sem treino", 1),
        ("3. Cross-Encoder treinado — self-attention conjunta sobre o par", 1),
        "Notebook: docs/demo_sala_aula.ipynb (caches e checkpoints já prontos, cada célula roda em segundos)",
        "A turma escolhe o número da pergunta (0 a 299) — resultado é genuinamente ao vivo, não ensaiado",
    ],
)
